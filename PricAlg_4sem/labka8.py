...
#Функия для построения правильного построения языка по правилам
...
# Условия прри котором будет строиться дерево или печать что язык недопускающий
