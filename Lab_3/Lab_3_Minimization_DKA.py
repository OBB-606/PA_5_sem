...
# Состояния автомата делятся на различные классы эквивалентности
# Т.е если есть группа эквивалентных состояний автомата, то они объединяются в одно состояние, тем самым избавляя автомат от избыточности сотсояний
#
#
#
...
with open('structure_lab_3.csv') as f_obj:
